...
class PreprocessAgent(Agent):
    ...
    def act(self, step: int, observation: dict, layer:int,
        ...
        act_res = self._pose_agent.act(step, observation,layer, deterministic)
    ...
    def update_summaries(self) -> List[Summary]:
        ...
        sums = [
            ...
            HistogramSummary('%s/low_dim_state_layer_0' % prefix,
                    self._replay_sample['low_dim_state_layer_0']),
            HistogramSummary('%s/low_dim_state_layer_0_tp1' % prefix,
                    self._replay_sample['low_dim_state_layer_0_tp1']),
            HistogramSummary('%s/low_dim_state_layer_1' % prefix,
                    self._replay_sample['low_dim_state_layer_1']),
            HistogramSummary('%s/low_dim_state_layer_1_tp1' % prefix,
                    self._replay_sample['low_dim_state_layer_1_tp1']),

            ScalarSummary('%s/low_dim_state_layer_0_mean' % prefix,
                    self._replay_sample['low_dim_state_layer_0'].mean()),
            ScalarSummary('%s/low_dim_state_layer_0_min' % prefix,
                    self._replay_sample['low_dim_state_layer_0'].min()),
            ScalarSummary('%s/low_dim_state_layer_0_max' % prefix,
                    self._replay_sample['low_dim_state_layer_0'].max()),
            
            ScalarSummary('%s/low_dim_state_layer_1_mean' % prefix,
                    self._replay_sample['low_dim_state_layer_1'].mean()),
            ScalarSummary('%s/low_dim_state_layer_1_min' % prefix,
